...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.updateMovies = function (movie) {
        var body = { title: movie.title, description: movie.description, year: movie.year };
...
var AppComponent = /** @class */ (function () {
    function AppComponent(api) {
        ...
        this.updateMovie = function () {
            _this.api.updateMovies(_this.selectedMovie).subscribe(function (data) {
                _this.getAllMovies();
            }, function (error) {
                console.log(error);
            });
...
module.exports = __webpack_require__(/*! /Users/rmiyazaki/Development/projects/djangular/crud/src/main.ts */"./src/main.ts");
